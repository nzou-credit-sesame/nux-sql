...
df[['payment', 'score_change']].groupby(['payment']).agg(['mean', 'median', 'size']).reset_index()


# In[ ]:


df[['payment', 'score_change']].groupby(['payment']).agg(lambda x: np.percentile(x['score_change'], q = 20))


# In[ ]:


df[['payment', 'score_change']].groupby(['payment']).agg(lambda x: np.percentile(x['score_change'], q = 80))
